...
export class City extends Component{
    ...
    FilterFn(){
        var CityIdFilter=this.state.CityIdFilter;
        ...
        this.setState({city:filteredData});
    ...
    sortResult(prop,asc){
        ...
        this.setState({city:sortedData});
    }

    changeCityIdFilter = (e)=>{
        this.state.CityIdFilter=e.target.value;
        this.FilterFn();
    }
    changeCityFilter = (e)=>{
    ...
    refreshList(){
        ...
        .then(data=>{
            this.setState({City:data,cityWithoutFilter:data});
        });
    }
...
<div>
    ...
    <tr>
        <th>
            ...
            onChange={this.changeCityIdFilter}
            placeholder="Filter"/>
            
            <button type="button" className="btn btn-light"
            onClick={()=>this.sortResult('CityId',true)}>
            ...
            <button type="button" className="btn btn-light"
            onClick={()=>this.sortResult('CityId',false)}>
    ...
    <tbody>
        {city.map(cy=>
            <tr key={cy.CityId}>
                ...
                <button type="button"
                className="btn btn-light mr-1"
                onClick={()=>this.deleteClick(cy.CityId)}>
